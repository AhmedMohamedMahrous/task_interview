            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8" style="color: #2d3748">
                            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                                <h1 style="color: crimson; font-size: 50px;text-align: center">Stack Task</h1>
                            </div>
                                    ...
                                    <div class="p-6">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4 text-lg leading-7 font-semibold">
                                                ...
                                                @elseif(auth()->user()->is_admin)
                                                    <a href="{{route("create_project")}}" class="underline text-gray-900 dark:text-white">
                                                        Create Project
                                                    </a>
                                                @else
                                                    <a href="{{route("tasks")}}" class="underline text-gray-900 dark:text-white">
                                                        Show Tasks
                                                    </a>
                                                @endguest
                                            </div>
                                        ...
                                        <div class="ml-12">
                                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                                @guest()
                                                    Login for create projects or execute tasks
                                                @elseif(auth()->user()->is_admin)
                                                    Create New Project
                                                @else
                                                    Show Tasks
                                    ...
                                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4 text-lg leading-7 font-semibold">
                                                ...
                                                @elseif(auth()->user()->is_admin)
                                                    <a href="{{route("show_projects")}}" class="underline text-gray-900 dark:text-white">
                                                        Show Projects
                                                    </a>
                                                @else
                                                    <a href="{{route("tasks")}}" class="underline text-gray-900 dark:text-white">
                                        ...
                                        <div class="ml-12">
                                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                                @guest()
                                                    Register for create projects or execute tasks
                                                @elseif(auth()->user()->is_admin)
                                                    Show Projects
                                                @else
                                                    Upload Tasks
